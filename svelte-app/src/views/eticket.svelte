...
<ul class="nav nav-fill" style="border-width: 1px;border-color: #eee;border-bottom-style: solid;">
    <li class="nav-item"><a class="nav-link active"><i class="fa fa-long-arrow-left"></i></a></li>
...
<div class="container d-flex flex-column align-items-center" style="margin-top: 10px;/*border: 2px solid #eee;*/border-radius: 5px;padding-top: 15px;padding-bottom: 15px;">
	<p>SCAN QR CODE TO DOWNLOAD TICKET IN MOBILE</p>
    <div class="box d-flex flex-column align-items-center">
        ...
        <img src="assets/img/qrcode.svg" style="margin-top: 20px;width: 150px;margin-bottom: 20px">

        <p> Amount Paid:- <b>Rs.{ amount }</b></p>
        <button class="btn btn-primary" type="button" style="margin-top: 10px;padding: 10px;width: 330px;cursor: pointer;">Download</button>
